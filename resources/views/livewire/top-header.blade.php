        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <li>
                ...
                <div class="d-flex">
                    ...
                    <span class="fw-semibold d-block">{{ $author->name }}</span>
                    <small class="text-muted">{{ $author->username }} ({{$author->authorType->name}})</small>
                    </div>
                </div>
                </a>
            </li>
            ...
            <li>
                <a class="dropdown-item" href="{{ route('author.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
